...
//    -The "addScenes()" function which can be used to add all scenarios to a new players DB
//
...
async function addScenes(){
    //adding all scenarios to the players DB
    //const remmy = await scenarios.deleteMany({}); <- deletes all scenarios from players DB before adding to prevent duplicates. NOTE: throws error if user is first time player.
...
//exporting function to add all scenes to be used elsewhere
